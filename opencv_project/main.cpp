...
int main(){
	...
	ViewSrc window1("Source_image", cv::WINDOW_AUTOSIZE);
	//	ViewSrc object creates new window
	ViewSrc window2("Processed_image", cv::WINDOW_AUTOSIZE);
	...
	//	Model class calls dnn model from enum type and Controller class sets this model to its local variable
